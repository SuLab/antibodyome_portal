...
urlpatterns = patterns(
    ...
    url(r'^update-project/(?P<abp_id>.+)', views.update_project, name="update_project"),
    ...
    url(r'^project-analysis/(?P<abp_id>.+)/$', views.submit_analyze, name="project-submit-analyze"),
    ...
    url(r'^count-ab/(?P<abs_id>.+)/$', views.count_ab, name="count-ab"),
