...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:\\APTANA\\abome\\sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '-(k!($i)a5$6=5=em((o2bj)g34dck#y@fuidc-k(&amp;w%s%qnk*'
...
ROOT_URLCONF = 'abome.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'abome.wsgi.application'
